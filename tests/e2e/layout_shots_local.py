"""Capture local screenshots of the redesigned layout for review."""

from playwright.sync_api import sync_playwright

URL = "http://127.0.0.1:5173"
OUT = "tests/.artifacts/layout-v2"
...
def fill_and_submit(page):
    ...
    page.locator("#today-brief .daily-card").first.wait_for(timeout=30_000)
...
with sync_playwright() as p:
    ...
    page.goto(URL, wait_until="networkidle")
    shoot(page, "desktop-today-empty")
