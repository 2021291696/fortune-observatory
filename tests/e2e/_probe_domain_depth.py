...
QUESTION = (
    "请基于我的疾厄宫及三方四正星情，结合命宫与八字日主，写一篇完整的白话健康分析："
    "先用一句话结论加一个比喻；然后分2-3段展开——我的体质与精力特点、最该留意的身体信号与"
    "生活习惯诱因、对宫和相关宫位带来的调节线索，每个命理术语第一次出现都立刻解释成白话；"
    "最后给2-4条建议，每条说清为什么、怎么做、怎么算做到了。不涉及任何诊断或用药。"
)
