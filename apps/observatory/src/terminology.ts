...
const pillarDomains = ['根基与长辈议题', '环境与同辈议题', '自身与亲密关系议题', '表达、作品与晚辈议题']
...
export const termGlossary: Record<string, string> = {
  ...
  居垣: '星曜落在自己五行的本命宫（如水星在巳/申），力量最强',
  升殿: '星曜躔在属于自己的二十八宿（如木星躔角宿），力量很强',
  命主: '命宫所在宫支的守护星（如命宫在卯属火，命主即火星），整张盘的第一主角',
  身主: '身宫所在宫支的守护星，代表身体与后天的守护力量',
  恩难仇用: '以命主五行为基准给其他星曜定关系：恩=生我（助力）、难=克我（压力）、用=我克（可控之财）、仇=我生（泄耗）',
  洞微大限: '七政四余的行运表：出童限后从命宫起顺行十二宫，各宫管固定年数（命15年、官禄15年…），标注昼段夜段',
  昼盘: '出生时太阳在地平之上——传统上昼生人重看太阳与日宿星曜',
  夜盘: '出生时太阳在地平之下——夜生人重看太阴与月宿星曜',
}
