...
const domainConfig: Record<AnalysisDomain, {
  ...
  health: {
    ...
    question: '请基于我的疾厄宫及三方四正星情，结合命宫与八字日主，写一篇完整的白话健康分析：先用一句话结论加一个比喻；然后分2-3段展开——我的体质与精力特点、最该留意的身体信号与生活习惯诱因、对宫和相关宫位带来的调节线索，每个命理术语第一次出现都立刻解释成白话；最后给2-4条建议，每条说清为什么、怎么做、怎么算做到了。不涉及任何诊断或用药。',
  },
  relationship: {
    palace: '夫妻', label: '姻缘', icon: Heart,
    action: '把沟通节奏、个人边界与冲突后的恢复方式分开观察，用真实互动校准命盘语言。',
    question: '请基于我的夫妻宫及三方四正星情，结合命宫与八字日主，写一篇完整的白话姻缘分析：先用一句话结论加一个比喻；然后分2-3段展开——我在亲密关系里的天然模式、容易在哪个环节卡住、对宫和相关宫位提示的相处思路，每个命理术语第一次出现都立刻解释成白话；最后给2-4条建议，每条说清为什么、怎么做、怎么算做到了。',
  },
  career: {
    palace: '官禄', label: '事业', icon: Briefcase,
    action: '把专业能力、责任边界与下一阶段作品拆开列出，先推进一个可以被验证的最小成果。',
    question: '请基于我的官禄宫及三方四正星情，结合命宫与八字日主，写一篇完整的白话事业分析：先用一句话结论加一个比喻；然后分2-3段展开——我的职业优势从哪来、容易踩的坑是什么、下一步的发力方向与相关宫位的配合，每个命理术语第一次出现都立刻解释成白话；最后给2-4条建议，每条说清为什么、怎么做、怎么算做到了。',
  },
  wealth: {
    palace: '财帛', label: '财运', icon: Coins,
    action: '先定义现金流、风险上限和不可承受损失，再讨论机会；命盘不能替代具体财务数据。',
    question: '请基于我的财帛宫及三方四正星情，结合命宫与八字日主，写一篇完整的白话财运分析：先用一句话结论加一个比喻；然后分2-3段展开——我的用钱与赚钱习惯、容易漏财或误判的环节、对宫和相关宫位提示的改善方向，每个命理术语第一次出现都立刻解释成白话；最后给2-4条建议，每条说清为什么、怎么做、怎么算做到了。',
  },
}
